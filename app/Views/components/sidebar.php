<?php
$uri = service('uri'); // e.g., dashboard/index
$current_uri = $uri->getSegment(1); // This gets 'main_transaction'
?>
<?php $userRole = (int) session()->get('role'); ?>
  <body class="  ">
    <!-- loader Start -->
    <div id="loading">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        <!-- <a class="nav-link active" aria-current="page" href="../dashboard/index.html"> -->
                            ...
                            <i class="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="" class="icon-20">
                        ...
                        <ul class="sub-nav collapse" id="horizontal-menu" data-bs-parent="#sidebar-menu">
                            <li class="nav-item">
                                <a class="nav-link " href="../dashboard/index-horizontal.html">
                                  <i class="icon">
                                        <svg class="icon-10" xmlns="" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                    ...
                    <li class="nav-item">
                        <!-- <a class="nav-link active" aria-current="page" href="../dashboard/index.html"> -->
                             <a class="nav-link <?= ($current_uri == 'purchase') ? 'active' : '' ?>" href="<?= base_url('/purchase') ?>">
                            <i class="icon">
                            ...
                            <span class="item-name">Meds Purchase</span>
                          
                        </a>
                    </li>
                  <li class="nav-item">
                        <!-- <a class="nav-link active" aria-current="page" href="../dashboard/index.html"> -->
                             <a class="nav-link <?= ($current_uri == 'issuance') ? 'active' : '' ?>" href="<?= base_url('/issuance') ?>">
                            <i class="icon">
                                <svg class="icon-20" xmlns="" width="20" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <span class="item-name">Meds Issuance</span>
                       ...
                       <li class="nav-item">
                        <!-- <a class="nav-link active" aria-current="page" href="../dashboard/index.html"> -->
                             <a class="nav-link <?= ($current_uri == 'medlist') ? 'active' : '' ?>" href="<?= base_url('/medlist') ?>">
                            <i class="icon">
                             <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="">
                            ...
                            <span class="item-name">Meds Registration</span>
                    ...
                    <?php if ($userRole === 1): ?>
                      <li class="nav-item">
                        <!-- <a class="nav-link active" aria-current="page" href="../dashboard/index.html"> -->
                             <a class="nav-link <?= ($current_uri == 'users') ? 'active' : '' ?>" href="<?= base_url('/users') ?>">
                             <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="">
                            ...
                            <span class="item-name">User Registration</span>
              ...
              <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                <!-- <li class="me-0 me-xl-2">
                  <a class="btn btn-primary btn-sm d-flex gap-2 align-items-center" aria-current="page" href="http://hopeui.iqonic.design/pro?utm_source=hopeui-free-demo&utm_medium=hopeui-free-demo&utm_campaign=hopeui-pro-launch" target="_blank">
                    <svg class="icon-16" width="16" viewBox="0 0 24 24" fill="none" xmlns="">
                        ...
                        <div class="m-0 border-0 shadow-none card">
                            <div class="p-0 ">
                                <ul class="p-0 list-group list-group-flush">
                                    <li class="iq-sub-card list-group-item"><a class="p-0" href="#"><img src="#" alt="img-flaf" class="img-fluid me-2" style="width: 15px;height: 15px;min-width: 15px;"/>Spanish</a></li>
                                    <li class="iq-sub-card list-group-item"><a class="p-0" href="#"><img src="#" alt="img-flaf" class="img-fluid me-2" style="width: 15px;height: 15px;min-width: 15px;"/>Italian</a></li>
                                    <li class="iq-sub-card list-group-item"><a class="p-0" href="#"><img src="#" alt="img-flaf" class="img-fluid me-2" style="width: 15px;height: 15px;min-width: 15px;"/>French</a></li>
                                    <li class="iq-sub-card list-group-item"><a class="p-0" href="#"><img src="#" alt="img-flaf" class="img-fluid me-2" style="width: 15px;height: 15px;min-width: 15px;"/>German</a></li>
                                    <li class="iq-sub-card list-group-item"><a class="p-0" href="#"><img src="#" alt="img-flaf" class="img-fluid me-2" style="width: 15px;height: 15px;min-width: 15px;"/>Japanese</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <li class="nav-item dropdown">
                  <!-- <a href="#"  class="nav-link" id="notification-drop" data-bs-toggle="dropdown" >
                      <svg class="icon-24" width="24" viewBox="0 0 24 24" fill="none" xmlns="">
                ...
                <li class="nav-item dropdown">
                  <a class="py-0 nav-link d-flex align-items-center" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <h6 class="mb-0 caption-title">
                        <?php $session = session(); $Fullname = $session->get('fullName'); echo $Fullname; ?></h6>
...
function logoutConfirm(e) {
    ...
    // Replace this with your theme's main color
    const currentColor = getComputedStyle(document.documentElement)
                          .getPropertyValue('--currentColor') || '#3498db';
    ...
    Swal.fire({
        ...
        confirmButtonColor: currentColor, // Use your current color
...
<style>
.swal2-border-radius {
    border-radius: 12px; /* Optional: rounder modal corners */
}
</style>
